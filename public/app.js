...
// Bridge for React updater UI until session state migrates off app.js.
window.addEventListener('switchboard:save-update-restart-state', () => {
...
// Auto-update UI → src/renderer (UpdateToast + useUpdater)
