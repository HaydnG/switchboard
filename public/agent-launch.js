/** Renderer-side agent launch helpers (UI catalog mirrors agent-runtimes/). */

const AGENT_RUNTIMES_UI = [
  {
    id: 'claude',
    label: 'Claude',
...
function getAgentRuntimeUi(id) {
  return AGENT_RUNTIMES_UI.find(r => r.id === id) || AGENT_RUNTIMES_UI[0];
}

function getLaunchableAgentRuntimes() {
  return AGENT_RUNTIMES_UI;
}

async function resolveLaunchOptions(runtimeId, project) {
